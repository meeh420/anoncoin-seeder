...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Anoncoin-seeder\n"
...
static const string mainnet_seeds[] = {"anoncoin.dnsseed.coinpool.in", "dnsseed01.anoncoin.net", ""};
static const string testnet_seeds[] = {"testnet-seed.anoncoin.net", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("aqmdzilaqayzjb6o.onion", 9377), true);
  }
  do {
